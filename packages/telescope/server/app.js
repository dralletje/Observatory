...
let { parse: jest_parse } = require('./jest-parser.js');
...
let get_app = ({ root }) => {
  ...
  let api = {
    ...
    retrieve_snapshot_content: async ({ file_path, snapshot_name }) => {
      ...
      // TODO: Get the git root, to get the relative path for `cat-file`
      // git rev-parse --show-toplevel
      // TODO: This will get the contents of the file as it is on HEAD (ignores uncommited changes)
      // git --git-dir=/git-compare.fixture/.git --work-tree=/git-compare.fixture cat-file blob HEAD:</path/to/file>
